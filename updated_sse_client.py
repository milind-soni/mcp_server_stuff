                                ...
                                match sse.event:
                                    case "endpoint":
                                        ...
                                        if sse.data.startswith('/'):
                                            ...
                                            endpoint_url = f"{url_parsed.scheme}://{url_parsed.netloc}{chat_path}{sse.data}"
                                        else:
                                            # If server sends relative path, use normal urljoin
                                            endpoint_url = urljoin(url, sse.data)
                                        
                                        logger.info(f"Received endpoint URL: {endpoint_url}")
                                        logger.debug(f"Original URL: {url}, SSE data: {sse.data}")
